...
Use `explore-investigating-a-codebase` to find existing test patterns before writing tests.
...
Check codebase for existing patterns with `explore-investigating-a-codebase`.
