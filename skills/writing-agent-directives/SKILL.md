...
Apply `prompt-security-hardening` alongside this skill. Directives that demonstrate unsafe secrets handling teach agents to leak secrets.
...
| Task tracking | Checklists without persistent tracking are easily skipped |
