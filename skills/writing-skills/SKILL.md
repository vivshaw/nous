...
Read `writing-agent-directives` first, for the underlying guidance on token efficiency, discovery optimization, and compliance techniques. This skill covers the TDD methodology specific to skill creation.
...
Use `testing-skills-with-subagents` for the complete methodology.
...
Use the host's task tracker to track each item when available.
...
**GREEN Phase:**
- [ ] Name is 1-64 lowercase letters, numbers, and hyphens; no leading, trailing, or consecutive hyphens
