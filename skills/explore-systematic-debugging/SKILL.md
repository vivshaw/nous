...
1. **Create Failing Test Case**
   ...
   - Use `execute-test-driven-development` for writing proper failing tests
...
**Related skills:**
- **`execute-test-driven-development`** - For creating failing test case (Phase 4, Step 1)
- **`critique-verifying-completion`** - Verify fix worked before claiming success
