...
- `research:visualizing-data`: A comprehensive skill for data visualization, including a house palette, style guide, and accessibility checks.
...
This skill embeds the Inter typeface (OFL 1.1, © The Inter Project Authors). See `skills/visualizing-data/assets/fonts/OFL.txt`.
